...
const ContentDatLaiMatKhau = () => {
    ...
    const checkToken = async () => {
      try {
        const response = await fetch(
          `https://backing-vietnam-bpko.onrender.com/login/kiem-tra-reset-token?token=${token}`
        );
  ...
  const handleResetPassword = async () => {
    try {
      ...
      const response = await fetch("https://backing-vietnam-bpko.onrender.com/login/dat-lai-mat-khau", {
        method: "POST",
        headers: {
