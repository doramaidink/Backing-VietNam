...
const ContentChitietdiadiem = () => {
  ...
  const socket = io.connect("https://backing-vietnam-bpko.onrender.com");
  ...
  useEffect(() => {
    const fetchGroups = async () => {
      try {
        const res = await axios.get(`https://backing-vietnam-bpko.onrender.com/nhom/${diaDiem._id}`);
  ...
  useEffect(() => {
    const getDanhGiaMoiNhat = async () => {
      try {
        const res = await axios.get(`https://backing-vietnam-bpko.onrender.com/danhgia/diadiem/${slug}?limit=2`);
        setReviewData({
  ...
  const handleJoinGroup = async () => {
    ...
    try {
      ...
      const res = await axios.post(`https://backing-vietnam-bpko.onrender.com/nhom/join/${selectedGroup._id}`, {
  ...
  const handleCreateGroup = async () => {
    ...
    try {
      const res = await axios.post("https://backing-vietnam-bpko.onrender.com/nhom", {
        ...groupForm,
  ...
  useEffect(() => {
    const getChiTietDiaDiem = async () => {
      try {
        const res = await axios.get(`https://backing-vietnam-bpko.onrender.com/chitietdiadiem/${slug}`);
  ...
  const fetchGuides = async () => {
    try {
      ...
      const res = await axios.get("https://backing-vietnam-bpko.onrender.com/huongdanvien");
  ...
  const handleHireGuide = (guide) => {
    ...
    const fullImage = `https://backing-vietnam-bpko.onrender.com/${cleanPath}`;
